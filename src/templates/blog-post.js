              ...
              <div className="column is-10 is-feature">
                <div className="columns is-centered is-desktop">
                  <div className="column is-10-desktop is-12-tablet">
                    ...
                    <div className="share is-feature-share">
                      <p className="heading">DELA</p>
                      <a href={'https://twitter.com/share?url=' + encodeURIComponent(shareUrl) + '&text=' + encodeURIComponent(title)} className="is-twitter is-share" target="_blank" rel="noopener noreferrer">
                      ...
                      <a href={'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(shareUrl) + '&t=' + encodeURIComponent(title)} className="is-facebook is-share" target="_blank" rel="noopener noreferrer">
                      ...
                      <a href={'https://www.linkedin.com/shareArticle?url=' + encodeURIComponent(shareUrl) + '&mini=true&title=' + encodeURIComponent(title)}  className="is-linkedin is-share" target="_blank" rel="noopener noreferrer">
